            ...
            <table class="table table-striped">
              ...
              <tbody>
                ...
                <tr>
                    ...
                    <td style="text-align: center"><a href="{{Route('tambahGaji',[$g->id])}}"><button class="btn btn-warning">Buat</button></a>
                <a href="{{Route('rincianGaji',[$g->id])}}"><button class="btn btn-secondary">Lihat</button></a>
				</tr>
               @php
                   $i++;
               @endphp
